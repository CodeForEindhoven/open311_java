...
public class JSONParser extends AbstractParser {
     ...
     * @throws JSONException        If the given service isn't correct.
     ...
     * @throws JSONException        If the given object is not correct.
     ...
     *
     * @param serviceRequest JSONObject representing the service definition data.
     * @return A service request object.
     * @throws MalformedURLException If the media URL isn't correct.
     * @throws DataParsingException  If the received parameters are not valid.
     * @throws JSONException         If there was any problem parsing any parameter.
     */
     ...
     * found.
     * @throws JSONException If there was any problem with the parsing.
     */
     ...
     * @throws JSONException If there was any problem.
     */
    private Boolean getBoolean(JSONObject object, String tag)
            throws JSONException {
        try {
            return Boolean.valueOf(object.getBoolean(tag));
        } catch (Exception e) {
