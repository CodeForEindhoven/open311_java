...
public class URLBuilder {
     ...
     * @throws MalformedURLException If one of the parts of the url (endpoint's base url,
     ...
     *
     * @param serviceCode Code of the service to find the definition.
     * @return An URL ready to be accessed.
     * @throws MalformedURLException If one of the parts of the url (endpoint's base url,
     *                               format...) is not correct.
     */
     ...
     *
     * @param token Token associated to a service request.
     * @return An URL ready to be accessed.
     * @throws MalformedURLException If one of the parts of the url (endpoint's base url,
     *                               format...) is not correct.
     */
     ...
     *
     * @param arguments  List of (key, value) pairs.
     * @param attributes List of attributes.
     * @return A list of (key, value) pairs with all the given data (arguments
     * and attributes).
     * @throws MalformedURLException If any of the arguments given is not allowed.
     */
     ...
     *
     * @param parameters List of pairs (key, value).
     ...
     *
     * @param base      Host address.
     * @param arguments List of pairs (key, value).
     * @return a URL built from the given data.
     * @throws MalformedURLException If there was any problem building the URL.
     */
     ...
     *
     * @param url            Base url.
     * @param jurisdictionId Given jurisdiction id.
     * @return The new url.
     */
